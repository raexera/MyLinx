<x-app-layout>
    <x-slot name="header">
        <div
            class="flex flex-col md:flex-row md:items-end justify-between gap-5 mt-2 lg:mt-0 w-full lg:pr-4 xl:pr-8 mb-2 relative z-10"
        >
            <div class="flex-1 w-full min-w-0 flex flex-col">
                <h1
                    class="text-[2.75rem] sm:text-5xl lg:text-[3.25rem] font-serif text-[#1A1C19] tracking-tight leading-[1.1] mb-2.5 truncate"
                >
                    Profil Usaha
                </h1>
                <p class="text-[14.5px] font-medium text-[#2E5136] opacity-80 leading-relaxed truncate">Manage your business identity, brand story, and how customers see you.</p>
            </div>
        </div>
    </x-slot>
    <!-- Content wrapper -->
    <div class="w-full lg:pr-4 xl:pr-8 pb-16 flex flex-col mt-8 relative z-10">
        @if (session('success'))
            <div
                class="bg-green-50 border border-green-200 text-green-700 text-sm font-medium px-5 py-3.5 rounded-2xl mb-6 flex items-center gap-2"
            >
        ...
        @endif
        <div
            class="absolute -top-40 right-0 w-[500px] h-[500px] bg-white rounded-full opacity-40 blur-[80px] pointer-events-none -z-10"
        ></div>
        <form
            action="{{ route('profil-usaha.update') }}"
            method="POST"
        ...
        >
            ...
            <div class="flex flex-col md:flex-row gap-8 md:gap-16 mb-12">
                <div class="md:w-[260px] shrink-0">
                    <h2
                        class="text-[1.35rem] font-serif text-[#1A1C19] mb-2 text-shadow-sm"
                    >
                        Visual Identity
                    </h2>
                    <p class="text-[12.5px] font-medium text-[#2E5136] opacity-70 leading-relaxed max-w-[220px]">Your logo is the face of your brand. Upload a high-quality image to build trust.</p>
                </div>
                <div class="flex-1">
                    <input
                        type="file"
                    ...
                    >
                        ...
                        <div class="text-center sm:text-left">
                            <h3
                                class="text-[15px] font-bold text-[#1A1C19] mb-1"
                            >
                                {{ $profil->logo ? 'Ganti Logo' : 'Upload Business Logo' }}
                            </h3>
                            <p class="text-[12.5px] font-medium text-gray-400 mb-3 leading-relaxed">Drag and drop your logo here, or click to browse.<br />
                            Recommended size: 500x500px (JPG, PNG)</p>
                            <span
                                class="inline-block bg-[#f9fafb] border border-[#E8EBED] text-gray-500 text-[10px] font-bold px-3 py-1 rounded-full uppercase tracking-wider"
                            >
                                Max 2MB
                            </span>
                        </div>
                ...
                <div class="flex-1 space-y-8">
                    ...
                    <div>
                        ...
                        <input
                            ...
                            name="nama_usaha"
                            id="nama_usaha"
                            value="{{ old('nama_usaha', $profil->nama_usaha) }}"
                            placeholder="e.g. Kopi Senja Nusantara"
                    ...
                    <div>
                        ...
                        >
                            <textarea
                                name="deskripsi"
                                id="deskripsi"
                                class="w-full min-h-[160px] bg-transparent border-none px-6 py-5 text-[14.5px] text-[#1A1C19] font-medium leading-relaxed resize-none focus:ring-0 outline-none placeholder:text-gray-300"
                                placeholder="Write about your journey, your values, and what makes your products special..."
                                required
            ...
            <div class="flex flex-col md:flex-row gap-8 md:gap-16 mb-8">
                <div class="md:w-[260px] shrink-0">
                    ...
                    <p class="text-[12.5px] font-medium text-[#2E5136] opacity-70 leading-relaxed max-w-[220px]">Make it easy for customers to reach you and follow your latest updates.</p>
                </div>
                <div
                ...
                >
                    ...
                    <div>
                        ...
                        >
                        <div
                            class="flex items-center bg-white border border-[#E8EBED] rounded-full h-14 px-5 shadow-[0_2px_10px_rgb(0,0,0,0.01)]"
                        >
                            ...
                            <input
                                ...
                                class="flex-1 bg-transparent border-none outline-none text-[14px] text-gray-400 font-medium p-0 focus:ring-0 w-full"
                                disabled
                            />
                        </div>
                    </div>
            ...
            <div class="flex flex-col md:flex-row gap-8 md:gap-16 mb-12">
                <div class="md:w-[260px] shrink-0">
                    ...
                    <p class="text-[12.5px] font-medium text-[#2E5136] opacity-70 leading-relaxed max-w-[220px]">Upload QRIS usahamu agar pelanggan bisa membayar langsung dengan scan. Sistem akan validasi otomatis bahwa gambar adalah QRIS resmi.</p>
                </div>
                <div class="flex-1">
                    <input
                        type="file"
                    ...
                    />
                    <div
                        class="bg-white rounded-[2rem] p-6 sm:p-8 border border-[#E8EBED] shadow-[0_4px_20px_rgb(0,0,0,0.015)]"
                    >
                        @if ($profil->qris_image)
                            ...
                            >
                                <div
                                    class="w-[160px] h-[160px] rounded-2xl overflow-hidden border border-[#E8EBED] shrink-0 bg-white p-2"
                                >
                                    <img
                                ...
                                <div class="flex-1 min-w-0">
                                    <div class="flex items-center gap-2 mb-3">
                                        <span
                                            class="inline-flex items-center gap-1.5 px-3 py-1 bg-[#ECFDF5] text-[#059669] text-[10px] font-bold uppercase tracking-widest rounded-full border border-[#A7F3D0]"
                                        >
                            ...
                            <div
                                id="qris-new-preview"
                                class="mt-4 hidden p-4 bg-amber-50 border border-amber-200 rounded-xl"
                            >
                                <p class="text-[12px] font-bold text-amber-800 mb-2">File baru dipilih:</p>
                                <img
                                    id="qris-new-img"
                                    class="w-[100px] h-[100px] object-contain rounded-lg bg-white border border-amber-100 p-1"
                                />
                        ...
                        @else
                            ...
                            >
                                <div
                                    class="border-2 border-dashed border-[#d1d5db] group-hover:border-[#2E5136]/50 rounded-2xl p-8 text-center bg-[#f9fafb] group-hover:bg-[#f2f4f3] transition-colors"
                                >
                                    <div
                                        class="w-14 h-14 mx-auto mb-4 rounded-full bg-white border border-[#E8EBED] flex items-center justify-center"
                                    >
                                    ...
                                    <span
                                        class="inline-block bg-white border border-[#E8EBED] text-gray-500 text-[10px] font-bold px-3 py-1 rounded-full uppercase tracking-wider"
                                    >
                        ...
                        @endif
                        <div
                            class="mt-5 p-4 bg-[#EFF6F2] rounded-xl flex items-start gap-3"
                        >
            ...
            >
                <a
                    ...
                    class="text-[13.5px] font-medium text-[#8b9196] hover:text-[#1A1C19] transition-colors order-2 sm:order-1"
                >
                    Batal
                </a>
                <button
                    type="submit"
                    class="w-full sm:w-auto bg-[#2E5136] hover:bg-[#1f3824] text-white rounded-full px-8 py-3.5 text-[14px] font-bold shadow-[0_4px_16px_rgb(46,81,54,0.25)] flex items-center justify-center gap-2.5 transition-all transform hover:-translate-y-0.5 order-1 sm:order-2"
                >
        ...
        <form
            id="qris-remove-form"
            action="{{ route('profil-usaha.remove-qris') }}"
            method="POST"
            class="hidden"
        >
            @csrf
