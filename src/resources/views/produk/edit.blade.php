            ...
            >
                ...
                <div>
                    ...
                    <div
                        ...
                        class="flex items-center gap-4 {{ $produk->gambar ? '' : 'hidden' }}"
                    >
                        <div
                        ...
                        <span
                            ...
                            >{{ $produk->gambar ? 'Foto saat ini' : '' }}</span
                        >
                    </div>
                    @error ('gambar')
                    ...
                    <div>
                        ...
                        >
                            ...
                            <input
                                ...
                                min="0"
                                step="1000"
                                class="flex-1 bg-transparent border-none outline-none text-[14px] font-bold p-0 focus:ring-0 text-[#1A1C19] w-full"
                                required
                            />
                        </div>
                        @error ('harga')
                ...
                <div class="pb-2">
                    ...
                    >
                        <textarea
                            name="deskripsi"
                            id="deskripsi"
                            class="w-full min-h-[140px] bg-transparent border-none px-5 py-4 text-[13.5px] text-[#1A1C19] font-medium leading-relaxed resize-none focus:ring-0 outline-none placeholder:text-gray-400"
