            ...
            >
                ...
                >
                    ...
                    >
                        ...
                        <div class="space-y-3">
                            <div
                                class="h-12 w-full bg-white rounded-xl border border-gray-100 shadow-sm flex items-center px-4"
                            >
                                <span class="text-xs font-semibold"
                                    >Produk Unggulan</span
                                >
                                <div
                                    class="ml-auto w-16 h-6 bg-[#2E5136] rounded-full flex items-center justify-center text-[10px] text-white"
                                >
                                    BELI
                                </div>
                            </div>
                        ...
                        <div
                            class="absolute bottom-6 right-6 w-12 h-12 bg-[#25D366] rounded-full shadow-lg flex items-center justify-center text-white"
                        >
