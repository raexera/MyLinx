<x-app-layout>
    <x-slot name="header">
        <div
            class="flex items-center pt-2 sm:pt-4 w-full text-[13.5px] font-bold text-gray-500 max-w-[900px] mx-auto"
        >
            <a
                href="{{ route('order.index') }}"
                class="flex items-center gap-2 hover:text-[#1A1C19] transition-colors"
            >
    ...
    <div class="w-full max-w-[900px] mx-auto pb-16 pt-5">
        <!-- White Card -->
        <div
            class="bg-white rounded-[2rem] shadow-[0_4px_24px_rgb(0,0,0,0.02)] border border-[#E8EBED] overflow-hidden flex flex-col"
        >
            <!-- Top Section -->
            <div class="px-8 sm:px-12 py-10">
                ...
                >
                    <div class="flex items-center gap-4">
                        ...
                        @endphp
                        <span
                            class="{{ $payBadge }} text-[11px] font-bold px-3 py-[5px] rounded-full tracking-[0.1em] uppercase"
                        >
                            {{ $payStatus }}
                        </span>
                        <span
                            class="text-[14px] font-medium text-[#8b9196] tracking-wide"
                        >
                ...
                <h1
                    class="text-5xl sm:text-[3.8rem] font-serif text-[#1A1C19] tracking-tight leading-none mb-3"
                >
                    Order
                    <span class="text-[#8b9196]">{{ $order->kode_order }}</span>
                </h1>
            ...
            <div
                class="flex flex-col md:flex-row divide-y md:divide-y-0 md:divide-x divide-[#E8EBED]"
            >
                <!-- Left Column: Customer Details -->
                <div class="w-full md:w-[45%] px-8 sm:px-12 py-10">
                    <h3
                        class="text-[10px] font-bold text-gray-400 uppercase tracking-[0.15em] mb-7"
                    >
                        CUSTOMER DETAILS
                    </h3>
                    <div class="space-y-8">
                        ...
                        <div class="flex gap-4">
                            <div
                                class="w-10 h-10 rounded-full bg-[#f9fafb] border border-[#E8EBED] flex items-center justify-center shrink-0 text-[#8b9196]"
                            >
                            ...
                            <div>
                                <div
                                    class="text-[15px] font-serif text-[#1A1C19] mb-1"
                                >
                                    {{ $order->nama_pembeli }}
                                </div>
                                <div
                                    class="text-[13px] font-medium text-[#8b9196]"
                                >
                                    {{ $order->email_pembeli }}
                                </div>
                            </div>
                        ...
                        <div class="flex gap-4">
                            ...
                            <div>
                                <div
                                    class="text-[13.5px] font-bold text-[#1A1C19] mb-1.5"
                                >
                                    Nomor Invoice
                                </div>
                                <div
                ...
                <div
                    class="w-full md:w-[55%] px-8 sm:px-10 py-10 flex flex-col h-full"
                >
                    <h3
                        class="text-[10px] font-bold text-gray-400 uppercase tracking-[0.15em] mb-7"
                    >
                    ...
                    <table class="w-full text-left">
                        <thead>
                            <tr>
                                <th
                                    class="font-medium text-[13px] text-[#8b9196] pb-4 tracking-wide font-normal"
                                >
                                    Product Name
                                </th>
                                <th
                                    class="font-medium text-[13px] text-[#8b9196] pb-4 text-center tracking-wide font-normal"
                                >
                                    Qty
                                </th>
                                <th
                                    class="font-medium text-[13px] text-[#8b9196] pb-4 text-right tracking-wide font-normal"
                                >
                                    Price
                                </th>
                            </tr>
                        ...
                        <tbody
                            class="divide-y divide-[#E8EBED] border-t border-[#E8EBED]"
                        >
                            @foreach ($order->orderItems as $item)
                                <tr>
                                    <td class="py-5">
                                        <div class="flex items-center gap-4">
                                            <div
                                                class="w-[46px] h-[46px] rounded-[0.8rem] overflow-hidden shrink-0 bg-gray-100 border border-[#E8EBED]"
                                            >
                                                ...
                                                @else
                                                    <div
                                                        class="w-full h-full flex items-center justify-center text-xl text-gray-300"
                                                    >
                                                        📦
                                                    </div>
                                                @endif
                                            ...
                                            <div>
                                                <div
                                                    class="text-[14.5px] font-medium text-[#1A1C19] mb-0.5"
                                                >
                                    ...
                                    <td
                                        class="py-5 text-center text-[14.5px] text-gray-500 font-medium"
                                    >
                                        {{ $item->jumlah }}
                                    </td>
                                    <td
                                        class="py-5 text-right text-[14.5px] text-[#1A1C19] font-medium"
                                    >
                    ...
                    <div class="mt-auto">
                        ...
                        <table class="w-full max-w-[280px] ml-auto">
                            <tr class="border-t border-[#E8EBED]">
                                <td
                                    class="text-[14px] font-medium text-[#1A1C19] pt-5 text-left"
                                >
                                    Total
                                </td>
                                <td
                                    class="text-[1.75rem] font-serif text-[#2E5136] pt-5 text-right leading-none"
                                >
            ...
            <div class="px-8 sm:px-12 py-6 bg-[#fcfcfd] space-y-4">
                @if (session('success'))
                    <div
                        class="rounded-xl bg-green-50 border border-green-100 px-4 py-3 text-sm font-medium text-green-700"
                    >
                        {{ session('success') }}
                    </div>
                @endif
                @switch ($order->status)
                    @case ('pending')
                        ...
                        >
                            <form
                                action="{{ route('order.mark-paid', $order) }}"
                                method="POST"
                                class="flex-1"
                            >
                                @csrf
                    ...
                    @case ('shipped')
                        <div
                            class="rounded-xl bg-blue-50 border border-blue-100 p-4 mb-2"
                        >
                            <div
                                class="flex items-center gap-2 text-[12px] font-bold text-blue-700 uppercase tracking-widest mb-1"
                            >
                            ...
                            <div class="text-[13px] text-blue-900">
                                ...
                                @if ($order->shipped_at)
                                    <span
                                        class="text-blue-600 text-[11px] ml-2"
                                        >{{ $order->shipped_at->diffForHumans() }}</span
                                    >
                                @endif
                            </div>
                        </div>
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-3">
                            ...
                            @endif
                            <form
                                action="{{ route('order.complete', $order) }}"
                                method="POST"
                            >
                                @csrf
                                @method ('PATCH')
                    ...
                    @case ('completed')
                        <div
                            class="rounded-xl bg-green-50 border border-green-100 p-4 text-center"
                        >
                            <div
                                class="text-[12px] font-bold text-green-700 uppercase tracking-widest"
                            >
                                ✓ Pesanan Selesai
                            </div>
                            <div class="text-[12px] text-green-600 mt-1">
                    ...
                    @case ('cancelled')
                        <div
                            class="rounded-xl bg-red-50 border border-red-100 p-4 text-center"
                        >
                            <div
                                class="text-[12px] font-bold text-red-700 uppercase tracking-widest"
                            >
                                ✕ Pesanan Dibatalkan
                            </div>
                        </div>
                ...
                @endswitch
                <div
                    class="pt-4 border-t border-[#E8EBED] flex items-center justify-between gap-3 flex-wrap"
                >
            ...
            >
                <div class="bg-white rounded-2xl max-w-md w-full p-8">
                    ...
                    >
                        ...
                        <div>
                            <label
                                class="block text-[12px] font-bold text-[#1A1C19] uppercase tracking-widest mb-2"
                                >Ekspedisi</label
                            >
                            <select
                                name="ekspedisi"
        ...
        <!-- Document Footer -->
        <div
            class="text-center mt-8 text-[11.5px] font-medium text-[#8b9196] pb-8"
        >
