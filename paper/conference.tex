...
Following the implementation stage, the developed MyLinx platform was evaluated by 8 MSME participants through a post-implementation questionnaire. This evaluation aimed to measure user perceptions regarding the effectiveness and usability of the platform after direct usage.
...
The system was developed using the Laravel framework with the Model-View-Controller (MVC) architectural pattern. The implementation process focused on creating a user-friendly interface that allows MSME users to build and manage business websites without requiring coding skills.

Figure \ref{fig:hero_page} shows the landing page of the MyLinx platform. This page provides an overview of the platform’s main features, including product catalog creation, WhatsApp ordering integration, and digital payment support.

\begin{figure}[H]
\centering
\includegraphics[width=0.48\textwidth]{assets/hero_page.png}
\caption{MyLinx Landing Page}
\label{fig:hero_page}
\end{figure}

Figure \ref{fig:dashboard} presents the dashboard interface used by MSME users to monitor business activities such as product statistics, orders, and storefront visitors.
\begin{figure}[H]
\centering
\includegraphics[width=0.48\textwidth]{assets/dashboard.png}
\caption{Dashboard Interface}
\label{fig:dashboard}
\end{figure}

Figure \ref{fig:product_management} shows the product management feature that allows users to add, edit, and manage product information through a simple interface.

\begin{figure}[H]
\centering
\includegraphics[width=0.48\textwidth]{assets/daftar_produk.png}
\caption{Product Management Interface}
\label{fig:product_management}
\end{figure}

Figure \ref{fig:order_management} illustrates the order management feature used to monitor incoming customer orders and transaction status.

\begin{figure}[H]
\centering
\includegraphics[width=0.48\textwidth]{assets/daftar_pesanan.png}
\caption{Order Management Interface}
\label{fig:order_management}
\end{figure}

Figure \ref{fig:portfolio_builder} presents the portfolio builder feature that enables users to showcase their business projects and services visually.

\begin{figure}[H]
\centering
\includegraphics[width=0.45\textwidth]{assets/portofolio_builder.png}
\caption{Portfolio Builder Feature}
\label{fig:portfolio_builder}
\end{figure}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.45\textwidth]{assets/Website_settings.png}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.45\textwidth]{assets/Store_front.png}
