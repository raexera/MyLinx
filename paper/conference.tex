...
The Micro, Small, and Medium Enterprises (MSME) sector plays a crucial role in 
...
\begin{figure}[H]
\centering
\includegraphics[width=0.65\columnwidth]{assets/Store_front.png}
...
Muhammad Haekal Aditya Rahmadyan contributed mainly to manuscript writing, data analysis, and research documentation. Rayhan Kafi Pratama and Santana Mena contributed primarily to system design and application development. Soni Yora supervised the research process and provided academic guidance. All authors contributed to the discussion, revision, and final approval of the manuscript.


\section*{Data Availability}

The implementation source code of the MyLinx platform is publicly available through the GitHub repository at \url{https://github.com/raexera/MyLinx/}. The deployed system can also be accessed through \url{https://mylinx.tech/}.
